...
public abstract class BibliotekaInterfejsTest {
	...
	@Test
	public void testDodajKnjiguViseKnjiga() {
		Knjiga k = new Knjiga();
		k.setIsbn(1234);
		k.setNaslov("Naslov 1");
	...
	@Test
	public void testPronadjiKnjiguJedanRezultatPretragaISBN() {
		Knjiga k = new Knjiga();
		k.setIsbn(1234);
		k.setNaslov("Naslov 1");
	...
	@Test
	public void testPronadjiKnjiguJedanRezultatPretragaNaslov() {
		Knjiga k = new Knjiga();
		k.setIsbn(1234);
		k.setNaslov("Naslov 1");
	...
	@Test
	public void testPronadjiKnjiguJedanRezultatPretragaIzdavac() {
		Knjiga k = new Knjiga();
		k.setIsbn(1234);
		k.setNaslov("Naslov 1");
		k.setIzdavac("Vulkan");
	...
	@Test
	public void testPronadjiKnjiguJedanRezultatPretragaAutor() {
		Knjiga k = new Knjiga();
		k.setIsbn(1234);
		k.setNaslov("Naslov 1");
		k.setIzdavac("Vulkan");
	...
	@Test
	public void testPronadjiKnjiguJedanRezultatPretragaSviParametri() {
		Knjiga k = new Knjiga();
		k.setIsbn(1234);
		k.setNaslov("Naslov 1");
		k.setIzdavac("Vulkan");
	...
	@Test
	public void testPronadjiKnjiguViseRezultataSviParametri() {
		Knjiga k = new Knjiga();
		k.setIsbn(1234);
		k.setNaslov("Naslov 1");
		k.setIzdavac("Vulkan");
	...
	@Test
	public void testPronadjiKnjiguNisuUnetiParametri() {
